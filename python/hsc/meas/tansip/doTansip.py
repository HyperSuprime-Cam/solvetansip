...
import hsc.meas.tansip.tansip            as hscTansip
...
def doTansip(matchListAllCcd, policy=None, camera=None, rerun=None):
    ...
    # The global tansip solver does not seem to use any metadata. Which is convenient,
    # since we no longer have metatdata handy.
    metadataGlobal = dafBase.PropertySet()
    ...
    resultWcs_V = hscTansip.F_WCS_TANSIP_V(matchListAllCcd, APROPPolicy, camera, metadataGlobal, True)
