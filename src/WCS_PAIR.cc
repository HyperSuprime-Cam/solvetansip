...
//--------------------------------------------------
    ...
    for(NUM=0;NUM<ALLREFNUM;NUM++)
    if(PAIR[NUM].FLAG == 1){
        data[0][FNUM]=PAIR[NUM].DIFF_SIP[0]=PAIR[NUM].X_IM_PIXEL[0]-PAIR[NUM].X_SIP_IM_PIXEL[0];
        data[1][FNUM]=PAIR[NUM].DIFF_SIP[1]=PAIR[NUM].X_IM_PIXEL[1]-PAIR[NUM].X_SIP_IM_PIXEL[1];
...
//--------------------------------------------------
    ...
    for(NUM=0;NUM<ALLREFNUM;NUM++)
    if(PAIR[NUM].FLAG == 1){
        data[0][FNUM]=PAIR[NUM].DIFF_PSIP[0]=PAIR[NUM].X_GLOBALCRPIX[0]-PAIR[NUM].X_PSIP_GLOBALCRPIX[0];
        data[1][FNUM]=PAIR[NUM].DIFF_PSIP[1]=PAIR[NUM].X_GLOBALCRPIX[1]-PAIR[NUM].X_PSIP_GLOBALCRPIX[1];
        if(fabs(MAXDIFF[0])<fabs(data[0][FNUM]))
	MAXDIFF[0]=data[0][FNUM];
        if(fabs(MAXDIFF[1])<fabs(data[1][FNUM]))
	MAXDIFF[1]=data[1][FNUM];
