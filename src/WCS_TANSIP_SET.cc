...
void    F_WCS_SETDEFAULTPOSITIONSfromPAF_SC(CL_CPROP *CPROP);
void    F_WCS_SETDEFAULTPOSITIONS_HSC(CL_CPROP *CPROP);
void    F_WCS_SETDEFAULTPOSITIONSfromPAF_HSC(CL_CPROP *CPROP);
...
//CHECKING PARAM
    ...
    if(APROP->CCDPOS==1)
        if(APROP->CCDNUM<11){
        F_WCS_SETDEFAULTPOSITIONSfromPAF_SC(CPROP);
        }else{
        F_WCS_SETDEFAULTPOSITIONSfromPAF_HSC(CPROP);
        }
...
void    F_WCS_SETDEFAULTPOSITIONS_SC(CL_CPROP *CPROP){
    CPROP[  0].GLOB_POS[0]=   4243.45;
    CPROP[  0].GLOB_POS[1]=   1951.42;
    CPROP[  0].GLOB_POS[2]=9.42553e-05;
    CPROP[  1].GLOB_POS[0]=   2121.68;
    CPROP[  1].GLOB_POS[1]=   1951.15;
    CPROP[  1].GLOB_POS[2]=0.000213211;
    CPROP[  2].GLOB_POS[0]=- 0.632341;
    CPROP[  2].GLOB_POS[1]=   1952.32;
    CPROP[  2].GLOB_POS[2]=0.000308735;
    CPROP[  3].GLOB_POS[0]=   4244.21;
    CPROP[  3].GLOB_POS[1]=  -2300.46;
    CPROP[  3].GLOB_POS[2]=0.000100736;
    CPROP[  4].GLOB_POS[0]=   2126.83;
    CPROP[  4].GLOB_POS[1]=  -2299.38;
    CPROP[  4].GLOB_POS[2]=0.000100736;
    CPROP[  5].GLOB_POS[0]=  -2.09345;
    CPROP[  5].GLOB_POS[1]=  -2305.18;
    CPROP[  5].GLOB_POS[2]=-6.8067e-05;
    CPROP[  6].GLOB_POS[0]=  -4246.74;
    CPROP[  6].GLOB_POS[1]=   1950.66;
    CPROP[  6].GLOB_POS[2]=0.000425587;
    CPROP[  7].GLOB_POS[0]=  -2123.46;
    CPROP[  7].GLOB_POS[1]=   1952.01;
    CPROP[  7].GLOB_POS[2]=0.000272656;
    CPROP[  8].GLOB_POS[0]=  -4244.22;
    CPROP[  8].GLOB_POS[1]=  -2299.95;
    CPROP[  8].GLOB_POS[2]=-2.88434e-05;
    CPROP[  9].GLOB_POS[0]=  -2122.81;
    CPROP[  9].GLOB_POS[1]=  -2299.69;
    CPROP[  9].GLOB_POS[2]=0.00026042;
}
void    F_WCS_SETDEFAULTPOSITIONS_HSC(CL_CPROP *CPROP){
