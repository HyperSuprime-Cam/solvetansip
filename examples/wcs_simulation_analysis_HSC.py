...
#            CCDPOSFILENAME = 'RREF/CCDPOS_SC_MODE0_'+str(REFNUM)+'_'+str(RANNUM)+'.dat'
#            RESIDUALFILENAME = 'RREF/RESIDUAL_SC_MODE0_'+str(REFNUM)+'_'+str(RANNUM)+'.dat'
...
REFNUMlist=[11,15,20,30,50,100,1000];
for REFNUM in range (10,11):
    if REFNUM in REFNUMlist:
        print 'HSC : ' , REFNUM
        for RANNUM in range (1000,1001):
...
#            doTansip.WCS_INPUT_CCD(WCSA_ASP,CCDFILENAME)
            CCDPOSFILENAME = 'RREF/CCDPOS_HSC_MODE1_TP6_'+str(REFNUM)+'_'+str(RANNUM)+'.dat'
            RESIDUALFILENAME = 'RREF/RESIDUAL_HSC_MODE1_TP6_'+str(REFNUM)+'_'+str(RANNUM)+'.dat'
